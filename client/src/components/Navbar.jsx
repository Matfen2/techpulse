    ...
    <nav className="bg-[var(--bg-base)] border-b border-[var(--border)] sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <Link to="/catalogue" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">
            Catalogue
          </Link>
          <Link to="/marketplace" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">
            Marketplace
          </Link>
          ...
          {isAuthenticated ? (
            <div className="flex items-center gap-4">
              ...
              <Link to="/dashboard" className="text-[var(--text-secondary)] hover:text-[var(--primary)] transition-colors text-sm">
                {user?.firstName}
              </Link>
              {user?.role === 'admin' && (
                <Link to="/admin" className="text-[var(--primary)] text-sm hover:underline">
                  Admin
                </Link>
              )}
              <button
            ...
            <div className="flex items-center gap-3">
              ...
              <Link to="/signup" className="px-4 py-2 text-sm bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-white rounded-lg transition-colors">
                S'inscrire
              </Link>
            </div>
          )}
