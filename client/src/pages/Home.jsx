    ...
    <div className="overflow-hidden">
      ...
      <section className="relative bg-[var(--bg-deep)] overflow-hidden">
        ...
        <div className="relative max-w-[1400px] mx-auto px-4 py-14 sm:py-20 lg:py-28 text-center">
          <motion.span
            ...
            className="inline-block px-4 py-1.5 bg-[var(--orange)]/10 text-[var(--orange)] rounded-full text-xs sm:text-sm font-medium mb-5 sm:mb-6 border border-[var(--orange)]/20"
          >
          ...
          <motion.h1
            ...
            className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[var(--text)] mb-4 sm:mb-6 leading-tight"
          >
            Découvrez les meilleurs
            <br />
            <span className="bg-gradient-to-r from-[var(--orange)] to-amber-400 bg-clip-text text-transparent inline-block mt-1">
              produits tech
            </span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-[var(--text-muted)] text-sm sm:text-base lg:text-lg max-w-2xl mx-auto mb-6 sm:mb-8 px-4"
          >
          ...
          >
            <Link
              to="/catalogue"
              className="w-full sm:w-auto px-6 sm:px-8 py-3 bg-gradient-to-r from-[var(--orange)] to-amber-500 text-white font-semibold rounded-xl transition-all hover:shadow-xl hover:shadow-[var(--orange)]/25 text-center text-sm sm:text-base"
            >
              Explorer le catalogue
            </Link>
            <Link
              to="/signup"
              className="w-full sm:w-auto px-6 sm:px-8 py-3 border border-[var(--border)] text-[var(--text-muted)] hover:text-[var(--text)] hover:border-[var(--orange)] rounded-xl transition-colors text-center text-sm sm:text-base"
            >
              Créer un compte
            </Link>
          </motion.div>
        ...
        <motion.img
          ...
          className="absolute left-4 lg:left-16 top-1/2 -translate-y-1/2 w-36 lg:w-56 xl:w-72 rotate-[-8deg] hidden md:block drop-shadow-2xl pointer-events-none"
        />
        <motion.img
          ...
          className="absolute right-4 lg:right-16 top-1/2 -translate-y-1/2 w-36 lg:w-56 xl:w-72 rotate-[8deg] hidden md:block drop-shadow-2xl pointer-events-none"
        />
      </section>
      ...
      <section className="bg-[var(--bg-base)] py-10 sm:py-10">
        <div className="max-w-8xl mx-auto px-4">
          ...
          >
            <h2 className="text-lg sm:text-2xl font-bold text-[var(--text)]">
              Produits populaires
            </h2>
            <Link to="/catalogue" className="text-[var(--orange)] hover:underline text-xs sm:text-sm">
              Voir tout →
            </Link>
          </motion.div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-6 sm:py-10">
        <motion.h2
          {...fadeUp}
          transition={{ duration: 0.4 }}
          className="text-lg sm:text-2xl font-bold text-[var(--text)] mb-8 sm:mb-10 text-center"
        >
          Comment ça marche ?
        </motion.h2>
              ...
              {marqueBrands.map((brand, i) => (
                ...
                >
                  <img
                    ...
                    alt={brand.name}
                    className="h-8 sm:h-16 lg:h-24 w-auto object-contain opacity-30 grayscale group-hover:opacity-100 group-hover:grayscale-0 group-hover:scale-110 transition-all duration-300"
                  />
                </Link>
              ))}
            </div>
      ...
      <section className="max-w-3xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-[var(--text-muted)] mb-6 max-w-xl mx-auto text-xs sm:text-sm lg:text-base">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              to="/marketplace/new"
              className="px-6 sm:px-8 py-3 bg-gradient-to-r from-[var(--orange)] to-amber-500 text-white font-semibold rounded-xl transition-all hover:shadow-xl hover:shadow-[var(--orange)]/25 text-sm sm:text-base"
            >
              Déposer une annonce
            </Link>
            <Link
              to="/marketplace"
              className="px-6 sm:px-8 py-3 border border-[var(--border)] text-[var(--text-muted)] hover:text-[var(--text)] hover:border-[var(--orange)] rounded-xl transition-colors text-sm sm:text-base"
            >
